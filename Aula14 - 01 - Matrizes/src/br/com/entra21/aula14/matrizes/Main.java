...
public class Main {
	...
	// Main
	// como o método main é static, tanto metodos ou variáveis devem ser static para
	...
	private static void aprenderMatrizesSimples() {
		...
		// apenas no ultimo indice da criação pela sintaxe ficam os valores
		...
		// qem decide o tamanho da minha matriz é o usuário
